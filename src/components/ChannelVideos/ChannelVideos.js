...
class ChannelVideos extends Component {
  ...
  render() {
    const { match, userVideos } = this.props;
    const { gameId, streamer } = match.params;
                ...
                <div key={index} className='videoCard'>
                  <div className='videoTopInfos'>
                    <div data-text='vues' className='stats'>
                      ...
                      <p>{video.view_count.toLocaleString()}</p>
                    </div>
                  ...
                  <Link to={videoUrl} params={{ gameId, videoId }}>
