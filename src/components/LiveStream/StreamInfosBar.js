...
function StreamInfosBar({ data, game, match, user }) {
        ...
        return (
          <div key={index} className='streamInfos'>
            <div className='gameInfos'>
              <img
                src={`${game.games[0].box_art_url.slice(0, -21)}.jpg`}
                alt={`${game.games[0].name} cover image`}
              />
              <div className='textInfos'>
                ...
                <div className='gameTitle'>
                  ...
                  <Link to={`/streams/${gameId}`}>
                    <p>{game.games[0].name}</p>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className='streamerInfos'>
              ...
              <div className='userViewCount'>
                ...
                <p>{user.user.data[0].view_count.toLocaleString()}</p>
              </div>
